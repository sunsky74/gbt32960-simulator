...
| P2 下载与校验 | `plans/2026-09-15-updater-phase-2-download-plan.md` | **done**(2026-09-16;Quality-LTDD:6 任务+评审×6+oracle 终审 Ready=Yes[Important 已修补 6d7dbf2];机器侧真实链验收:拒签+happy path 双 PASS[v0.1.0 已补传校验资产];UI 人工走查以等价证据替代记录于 rehearsal-checklist;commits `1082e78..6d7dbf2`) | 已合并并推送双远端(完成) | P1 ✅ | AC-4/5;AC-12(SHA256SUMS+签名部分);AC-11(白名单修正);AC-9(update:progress);AC-15(清理) |
| P3 替换与重启 | `docs/superpowers/plans/2026-09-17-updater-phase-3-apply-plan.md` | in-progress | — | P2 | AC-6/7/8/13/14;AC-12(installscope 部分) |
