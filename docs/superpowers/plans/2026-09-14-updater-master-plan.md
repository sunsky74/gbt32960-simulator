...
| P2 下载与校验 | `plans/2026-09-15-updater-phase-2-download-plan.md` | **in-progress**(Quality-LTDD 执行中) | Task-1 实现 | P1 ✅ | AC-4/5;AC-12(SHA256SUMS+签名部分);AC-11(白名单修正);AC-9(update:progress);AC-15(清理) |
