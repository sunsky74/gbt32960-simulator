...
|---|---|---|---|---|---|
| P1 版本与检查 | `plans/2026-09-14-updater-phase-1-check-plan.md` | **done**(2026-09-15;Quality-LTDD:6 任务+评审×6+oracle 终审;实机验收全链路闭合[toast/跳转/跳过,skippedVersion 机器验证];commits `b3a8c41..16915bd`) | 已合并 main(推送待指示) | 无 | AC-1/2/3 |
